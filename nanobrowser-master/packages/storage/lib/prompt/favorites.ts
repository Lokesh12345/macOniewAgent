...
const defaultFavoritePrompts = [
  ...
  },
  {
    ...
    content: 'Follow us at https://x.com/oniew_agent to stay updated on the latest news and features!',
  },
  {
    title: '🌟 Star us on GitHub!',
    content:
      "Open the Oniew Agent repository at https://github.com/oniew/oniew-agent and check if you've already starred it. If not, please support us by giving us a star!",
  },
];
